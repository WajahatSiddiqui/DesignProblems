...
/**
 * A memory that associates users with the groups that they belong to.
 *
 * @author wajahat
 */
public interface MembershipService {
    ...
    /**
     * Removes all the users which are part of given group
     * @param group the group that the users needs to be removed
     *
     */
